...
namespace SmartBot
{
	public partial class fCaiDatTuongTac_Nhom : Form
	{
		public fCaiDatTuongTac_Nhom()
		{
			InitializeComponent();
			LoadData();
		}
		...
		public List<PhanHoi> listBaiDang_Load = new List<PhanHoi>();
		...
		private void btn_Them_Click(object sender, EventArgs e)
		{
			...
			MessageBox.Show("Đã cấu hình thành công tương tác cho Nhóm", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
			this.Hide();
		}
		...
		private void btn_AddContent_Click(object sender, EventArgs e)
		{
			...
			themNoiDung.typeNoiDung = "Group";
			themNoiDung.Text = "Thêm Bài đăng lên Nhóm";
			themNoiDung.ShowDialog();
			LoadData();
		}

		private void fCaiDatTuongTac_Nhom_Load(object sender, EventArgs e)
		{
